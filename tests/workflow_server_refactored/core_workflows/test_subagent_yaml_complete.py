            ...
            if "steps" in remaining_step:
                for step in remaining_step["steps"]:
                    ...
                    if step["type"] == "user_message":
                        print(f"   User message will be implicitly completed")
