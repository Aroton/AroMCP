...
class TestComplexValidationExpressions:
    ...
    def test_user_input_with_expression_based_validation(self):
        ...
        state_manager = Mock()
        state_manager.read.return_value = {"state": {"min_quantity": 10, "max_quantity": 100}}
    ...
    def test_user_input_with_conditional_validation(self):
        ...
        state_manager = Mock()
        state_manager.read.return_value = {"state": {"is_premium_user": False}}
        workflow_id = "test_workflow_123"
    ...
    def test_user_input_with_custom_error_messages(self):
        ...
        step_definition = {
            ...
            "input_type": "string",
            "validations": [
                {"expression": "value.length >= 8", "message": "Password must be at least 8 characters long"},
                {
                    "expression": "value.match(/[A-Z]/)",
                    "message": "Password must contain at least one uppercase letter",
                },
                {"expression": "value.match(/[0-9]/)", "message": "Password must contain at least one number"},
                {
...
class TestLongInputAndTimeoutScenarios:
    ...
    def test_user_input_with_progressive_disclosure(self):
        ...
        step_definition = {
            ...
            "fields": [
                {"name": "mode", "type": "choice", "choices": ["basic", "advanced"], "default": "basic"},
                {
...
class TestUserInputIntegrationWithInfrastructure:
    ...
    def test_user_input_with_timeout_manager_integration(self):
        ...
        step_definition = {"prompt": "Enter your response:", "input_type": "string", "timeout_seconds": 120}
    ...
    def test_user_input_with_debug_manager_tracking(self):
        ...
        step_definition = {"prompt": "Enter debug value:", "input_type": "string", "debug_capture": True}
    ...
    def test_user_input_with_performance_monitoring(self):
        ...
        monitor.start_operation(
            "user_input_collection", {"workflow_id": "test_workflow_123", "input_type": "complex_form"}
        )

        step_definition = {"prompt": "Complete the form:", "input_type": "structured", "performance_tracking": True}
    ...
    def test_user_input_validation_error_recovery(self):
        ...
        from aromcp.workflow_server.errors.handlers import ErrorHandler, ErrorHandlerRegistry
        ...
        validation_handler = ErrorHandler(
            strategy=ErrorStrategyType.RETRY, retry_count=3, retry_delay=1000, retry_on_error_types=["ValidationError"]
        )
