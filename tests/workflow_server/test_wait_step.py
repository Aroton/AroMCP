...
class TestWaitStepBehavior:
    ...
    def test_wait_step_pauses_execution_for_client_polling(self):
        ...
        step_definition = {"message": "Waiting for external process to complete..."}
    ...
    def test_wait_step_displays_optional_message(self):
        ...
        step_definition = {"message": "Please check the external service status and continue when ready"}
    ...
    def test_wait_step_preserves_workflow_state(self):
        ...
        step_definition = {"message": "Waiting for user confirmation..."}
    ...
    def test_wait_step_timeout_configuration_future_enhancement(self):
        ...
        step_definition = {"message": "Waiting with timeout...", "timeout_seconds": 300}  # 5 minutes
    ...
    def test_wait_step_workflow_id_handling(self):
        ...
        step_definition = {"message": "Testing workflow ID handling"}
...
class TestWaitStepIntegration:
    ...
    def test_wait_step_with_subsequent_steps(self):
        ...
        step_definition = {"message": "Waiting before next operation..."}
    ...
    def test_wait_step_in_loop_constructs(self):
        ...
        step_definition = {"message": "Waiting in loop iteration..."}
    ...
    def test_wait_step_error_handling(self):
        ...
        step_definition = {"message": 12345}  # Invalid type, should be string
    ...
    def test_wait_step_with_empty_message(self):
        ...
        step_definition = {"message": ""}  # Empty string
    ...
    def test_wait_step_queue_integration_signals(self):
        ...
        step_definition = {"message": "Queue integration test"}
    ...
    def test_wait_step_state_manager_not_used(self):
        ...
        step_definition = {"message": "State manager test"}
    ...
    def test_wait_step_concurrent_processing(self):
        ...
        step_definition = {"message": "Concurrent processing test"}
    ...
    def test_wait_step_message_variable_substitution_readiness(self):
        ...
        step_definition = {"message": "Waiting for {{ process_name }} to complete..."}
    ...
    def test_wait_step_with_complex_object_message(self):
        ...
        step_definition = {"message": {"key": "value", "nested": [1, 2, 3]}}
