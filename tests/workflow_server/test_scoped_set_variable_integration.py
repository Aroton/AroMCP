...
class TestScopedSetVariableIntegration:
    ...
    def test_set_variable_with_nested_paths(self):
        ...
        updates = [{"path": "this.config.debug", "value": True}, {"path": "global.settings.timeout", "value": 30}]
    ...
    def test_set_variable_operation_types_with_scoped_paths(self):
        ...
        # Set initial values
        initial_updates = [{"path": "this.counter", "value": 0}, {"path": "global.items", "value": ["initial"]}]
