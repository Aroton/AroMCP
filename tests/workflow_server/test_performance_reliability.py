...
class TestConcurrencyThreadSafety:
    ...
    def test_concurrent_workflow_execution_isolation(self):
        ...
        workflow_def = WorkflowDefinition(
            ...
            inputs={},
            steps=[WorkflowStep(id="step1", type="shell_command", definition={"command": "echo 'workflow test'"})],
        )
    ...
    def test_parallel_subagent_resource_management(self):
        ...
        def mock_execute_subagent(task_definition, item, context):
            ...
            return {"status": "success", "result": f"processed_{item}", "item": item}
        ...
        workflow_step = WorkflowStep(id="parallel_resource_test", type="parallel_foreach", definition=step_definition)
    ...
    def test_state_update_race_condition_prevention(self):
        ...
        def execute_concurrent_update(thread_id):
            """Execute state update in thread."""
            workflow_step = WorkflowStep(id=f"step_{thread_id}", type="shell_command", definition=step_definition)
...
class TestResourceManagement:
    ...
    def test_memory_usage_management_large_states(self):
        ...
        large_state = {f"key_{i}": f"large_value_{'x' * 1000}_{i}" for i in range(1000)}
        ...
        workflow_def = WorkflowDefinition(
            ...
            state_schema=StateSchema(),
            inputs={},
            steps=[WorkflowStep(id="step1", type="shell_command", definition={"command": "echo memory_test"})],
        )
    ...
    def test_workflow_garbage_collection(self):
        ...
        for i in range(10):
            workflow_def = WorkflowDefinition(
                ...
                state_schema=StateSchema(),
                inputs={},
                steps=[WorkflowStep(id="step1", type="shell_command", definition={"command": f"echo gc_test_{i}"})],
            )
    ...
    def test_resource_limits_and_quotas(self):
        ...
        try:
            with patch("psutil.virtual_memory") as mock_memory:
                ...
                step_definition = {"type": "shell_command", "command": "echo resource_test"}

                workflow_step = WorkflowStep(id="resource_limit_test", type="shell_command", definition=step_definition)
...
class TestMonitoringObservability:
    ...
    def test_workflow_execution_metrics_tracking(self):
        ...
        workflow_def = WorkflowDefinition(
            ...
            state_schema=StateSchema(),
            inputs={},
            steps=[WorkflowStep(id="step1", type="shell_command", definition={"command": "echo metrics_test"})],
        )
    ...
    def test_audit_trail_generation(self):
        ...
        step_definition = {"type": "shell_command", "command": "echo audit_test"}

        workflow_step = WorkflowStep(id="audit_test_step", type="shell_command", definition=step_definition)
    ...
    def test_performance_metrics_collection(self):
        ...
        step_definition = {"type": "shell_command", "command": "echo performance_test"}

        workflow_step = WorkflowStep(id="performance_test_step", type="shell_command", definition=step_definition)
...
class TestDebugModeObservability:
    ...
    def test_execution_mode_tracking_parallel_vs_serial(self):
        ...
        workflow_def = WorkflowDefinition(
            ...
            version="1.0.0",
            config={"debug_mode": True, "execution_mode": "serial"},
            steps=[
                {"id": "step1", "type": "shell_command", "command": "echo debug_test_1"},
                {"id": "step2", "type": "shell_command", "command": "echo debug_test_2"},
            ],
        )
    ...
    def test_performance_comparison_metrics(self):
        ...
        for mode in modes:
            workflow_def = WorkflowDefinition(
                ...
                version="1.0.0",
                config={"debug_mode": True, "execution_mode": mode},
                steps=[
                    {"id": "step1", "type": "shell_command", "command": "echo test_1"},
                    {"id": "step2", "type": "shell_command", "command": "echo test_2"},
                ],
            )
        ...
        for mode in ["parallel", "serial"]:
            ...
            with patch.object(executor, "_execute_workflow_in_mode") as mock_execute:
                mock_execute.return_value = {
                    "status": "completed",
                    "final_state": {"counter": 0, "step1_completed": True, "step2_completed": True},
                }
    ...
    def test_debug_mode_step_execution_tracing(self):
        ...
        step_definition = {"type": "shell_command", "command": "echo debug_trace_test"}

        workflow_step = WorkflowStep(id="debug_trace_step", type="shell_command", definition=step_definition)
    ...
    def test_debug_mode_state_change_monitoring(self):
        ...
        workflow_step = WorkflowStep(id="state_change_step", type="shell_command", definition=step_definition)
