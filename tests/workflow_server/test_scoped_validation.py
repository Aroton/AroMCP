...
class TestScopedValidation:
        ...
        workflow = {
            ...
            "steps": [
                ...
                },
                {
                    ...
                    "tool": "test_tool2", 
                    "parameters": {
                        "nested": "{{ global.deeply.nested.value }}"
                    }
                }
            ]
        }
                    ...
                    "body": [
                        {
                            ...
                            "tool": "test_tool",
                            "parameters": {
                                "item": "{{ loop.item }}"  # Invalid in while_loop
                            }
                        }
                    ]
                }
                    ...
                    "body": [
                        {
                            ...
                            "tool": "test_tool",
                            "parameters": {
                                "iteration": "{{ loop.iteration }}"  # Invalid in foreach
                            }
                        }
                    ]
                }
    ...
    def test_backward_compatibility_with_legacy_syntax(self):
        ...
        workflow = {
            ...
            "version": "1.0.0",
            "default_state": {
                "state": {"counter": 0, "data": {"value": "test"}}
            },
            "state_schema": {
                "computed": {
                    "doubled": {
        ...
        workflow = {
            ...
            "sub_agent_tasks": {
                "process_item": {
                    ...
                    "default_state": {
                        "state": {"item_data": None}
                    },
                    "inputs": {
                        "item": {"type": "object", "description": "Item to process"}
                    },
                    "state_schema": {
                        "computed": {
                            "processed": {
                                "from": "inputs.item",
                                "transform": "input.processed = true; input"
                            }
                        }
                    },
                    "steps": [
    ...
    def test_suggestions_for_scoped_variables(self):
        ...
        workflow = {
            ...
            "version": "1.0.0",
            "default_state": {
                "state": {"counter": 0, "user_data": {"name": "test"}}
            },
            "state_schema": {
                "computed": {
                    "user_info": {
            ...
            "steps": [
                {
                    ...
                    "tool": "test_tool",
                    "parameters": {
                        "typo": "{{ this.countr }}"  # Typo in counter
                    }
                }
            ]
        }
