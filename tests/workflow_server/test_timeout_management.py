...
class TestStepLevelTimeouts:
    ...
    def test_shell_command_timeout_enforcement(self):
        ...
        workflow_step = WorkflowStep(id="timeout_test", type="shell_command", definition=step_definition)
    ...
    def test_step_timeout_configuration_inheritance(self):
        ...
        step_definition = {"command": "echo test", "timeout": 2}  # Explicit timeout

        workflow_step = WorkflowStep(id="inheritance_test", type="shell_command", definition=step_definition)
    ...
    def test_timeout_error_handling_strategies(self):
        ...
        for strategy in strategies:
            ...
            workflow_step = WorkflowStep(
                id=f"strategy_test_{strategy}", type="shell_command", definition=step_definition
            )
...
class TestTimeoutErrorHandling:
    ...
    def test_timeout_with_retry_strategy(self):
        ...
        workflow_step = WorkflowStep(id="retry_timeout_test", type="shell_command", definition=step_definition)
    ...
    def test_timeout_with_fallback_strategy(self):
        ...
        step_definition = {
            "command": "echo test",
            "timeout": 1,
            "error_handling": {"strategy": "fallback", "fallback_value": "backup_result"},
        }

        workflow_step = WorkflowStep(id="fallback_timeout_test", type="shell_command", definition=step_definition)
    ...
    def test_timeout_with_fail_strategy(self):
        ...
        step_definition = {"command": "echo test", "timeout": 1, "error_handling": {"strategy": "fail"}}

        workflow_step = WorkflowStep(id="fail_timeout_test", type="shell_command", definition=step_definition)
    ...
    def test_timeout_configuration_validation(self):
        ...
        valid_step = WorkflowStep(
            id="valid_timeout",
            type="shell_command",
            definition={"command": "echo test", "timeout": 30, "error_handling": {"strategy": "fail"}},  # Valid timeout
        )
    ...
    def test_timeout_warning_threshold_configuration(self):
        ...
        workflow_step = WorkflowStep(id="warning_timeout_test", type="shell_command", definition=step_definition)
