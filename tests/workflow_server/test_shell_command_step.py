...
class TestShellCommandExecution:
    ...
    def test_shell_command_basic_execution(self):
        ...
        step_definition = {"command": "echo 'Hello World'"}
    ...
    def test_shell_command_working_directory_specification(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            step_definition = {"command": "ls test.txt", "working_directory": temp_dir}
    ...
    def test_shell_command_output_capture_stdout_stderr(self):
        ...
        step_definition = {"command": "echo 'stdout message' && echo 'stderr message' >&2"}
    ...
    def test_shell_command_exit_code_handling(self):
        ...
        step_definition = {"command": "exit 42"}  # Command that returns non-zero exit code
    ...
    def test_shell_command_state_updates_with_output(self):
        ...
        step_definition = {"command": "echo 'test output'", "state_update": {"command_result": "{{ output.stdout }}"}}
...
class TestShellCommandExecutionContext:
    ...
    def test_shell_command_server_execution_context(self):
        ...
        step_definition = {"command": "pwd", "execution_context": "server"}
    ...
    def test_shell_command_client_execution_context(self):
        ...
        step_definition = {"command": "echo 'client command'", "execution_context": "client"}
    ...
    def test_shell_command_context_parameter_validation(self):
        ...
        step_definition = {"command": "echo 'test'", "execution_context": "invalid_context"}
...
class TestShellCommandErrorHandling:
    ...
    def test_shell_command_timeout_graceful_termination(self):
        ...
        step_definition = {
            "command": "sleep 10",
            "timeout": 1,
            "error_handling": {"strategy": "fail", "timeout_signal": "SIGTERM"},
        }
    ...
    def test_shell_command_invalid_command_handling(self):
        ...
        step_definition = {"command": "nonexistent_command_12345"}
    ...
    def test_shell_command_working_directory_not_exists(self):
        ...
        step_definition = {"command": "pwd", "working_directory": "/nonexistent/directory/path"}
    ...
    def test_shell_command_relative_working_directory(self):
        ...
        step_definition = {"command": "pwd", "working_directory": "."}
    ...
    def test_shell_command_state_updates_field_variations(self):
        ...
        step_definition = {
            "command": "echo 'test'",
            "state_updates": {"cmd_output": "{{ output.stdout }}", "cmd_exit_code": "{{ output.exit_code }}"},
        }
