    ...
    def test_conditional_branching_while_loop_support(self):
        ...
        body_step = WorkflowStep(
            ...
            definition={
                ...
                "state_update": {"path": "raw.counter", "value": "$(({{ raw.counter }} + 1))"},
            },
        )
    ...
    def test_frame_management(self):
        ...
        steps = [
            ...
            WorkflowStep(
                id="step2",
                type="shell_command",
                definition={"command": "echo 'test'", "state_update": {"path": "state.test", "value": "updated"}},
            ),
        ]
...
class TestWhileLoopConditionFix:
                    ...
                    "body": [
                        {
                            ...
                            "state_update": {"path": "state.attempt_count", "value": "{{ state.attempt_count + 1 }}"},
                        }
                    ],
                    "max_iterations": 5,
                },
    ...
    def test_while_loop_condition_not_template_processed(self):
        ...
        step_definition = {
            ...
            "body": [{"id": "process_item", "type": "user_message", "message": "Processing item"}],
        }

        # Create WorkflowStep object
        step = WorkflowStep(id="while_step", type="while_loop", definition=step_definition)

        # Mock state with nested structure (flattened for while_loop processor)
        mock_state = {"state.counter": 2}
...
class TestInfiniteLoopDetection:
    ...
    def test_while_loop_max_iterations_enforcement(self):
        ...
        loop_state = LoopState(loop_type="while", loop_id="test_loop", max_iterations=1000)  # Default safety limit
    ...
    def test_resource_based_loop_termination(self):
        ...
        resource_manager.set_workflow_limits(workflow_id="wf_123", max_memory_mb=100, max_cpu_percent=50)

        # Allocate initial resources
        allocated = resource_manager.allocate_resources(
            workflow_id="wf_123", requested_memory_mb=50, requested_cpu_percent=25
        )
        assert allocated
        ...
        while not loop_state.is_complete() and iterations < 100:
            ...
            can_continue = resource_manager.check_resource_availability(workflow_id="wf_123", required_memory_mb=10)
    ...
    def test_loop_with_circuit_breaker_protection(self):
        ...
        breaker = resource_manager.create_circuit_breaker("loop_operations", failure_threshold=3, timeout_seconds=1.0)
