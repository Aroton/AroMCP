...
class TestCallGraphBuilder:
    ...
    def test_conditional_execution_paths(self, simple_calls_file):
        ...
        response = get_call_trace_impl(
            entry_point="login", file_paths=[simple_calls_file], max_depth=5, analyze_conditions=True
        )
    ...
    def test_deep_call_chain_detection(self, simple_calls_file):
        ...
        response = get_call_trace_impl(entry_point="login", file_paths=[simple_calls_file], max_depth=10)
    ...
    def test_method_call_detection(self, class_methods_file):
        ...
        response = get_call_trace_impl(entry_point="createUser", file_paths=[class_methods_file], max_depth=10)
    ...
    def test_static_method_calls(self, class_methods_file):
        ...
        response = get_call_trace_impl(
            entry_point="isValid", file_paths=[class_methods_file], max_depth=5  # EmailValidator.isValid
        )
    ...
    def test_constructor_and_instance_method_calls(self, class_methods_file):
        ...
        response = get_call_trace_impl(
            entry_point="createFromCart", file_paths=[class_methods_file], max_depth=8  # OrderEntity.createFromCart
        )
    ...
    def test_async_function_call_detection(self, async_patterns_file):
        ...
        response = get_call_trace_impl(
            entry_point="complexAsyncWorkflow", file_paths=[async_patterns_file], max_depth=10
        )
...
class TestCallSiteDetection:
    ...
    def test_direct_function_calls(self, fixtures_dir):
        ...
        response = get_call_trace_impl(entry_point="validateCredentials", file_paths=[simple_calls], max_depth=5)
    ...
    def test_object_method_calls(self, fixtures_dir):
        ...
        response = get_call_trace_impl(entry_point="findUser", file_paths=[simple_calls], max_depth=3)
    ...
    def test_dynamic_property_access(self, fixtures_dir):
        ...
        response = get_call_trace_impl(entry_point="executeCommand", file_paths=[event_system], max_depth=8)
    ...
    def test_callback_function_calls(self, fixtures_dir):
        ...
        response = get_call_trace_impl(entry_point="callbackPatterns", file_paths=[async_patterns], max_depth=10)
...
class TestCrossFileCallAnalysis:
    ...
    def test_multiple_file_analysis(self, fixtures_dir):
        ...
        files = [str(fixtures_dir / "simple_calls.ts"), str(fixtures_dir / "class_methods.ts")]

        response = get_call_trace_impl(entry_point="login", file_paths=files, max_depth=10)
    ...
    def test_project_wide_analysis(self, fixtures_dir):
        ...
        response = get_call_trace_impl(entry_point="login", file_paths=files, max_depth=8)  # Analyze multiple files
    ...
    def test_nonexistent_file_handling(self, fixtures_dir):
        ...
        response = get_call_trace_impl(
            entry_point="login", file_paths=["nonexistent.ts", str(fixtures_dir / "simple_calls.ts")], max_depth=5
        )
...
class TestStaticCallGraphAccuracy:
    ...
    def test_function_signature_matching(self, fixtures_dir):
        ...
        response = get_call_trace_impl(
            entry_point="UserService", file_paths=[class_methods], max_depth=5  # Constructor or class reference
        )
        ...
        response = get_call_trace_impl(entry_point="createUser", file_paths=[class_methods], max_depth=8)
    ...
    def test_overloaded_function_handling(self, fixtures_dir):
        ...
        response = get_call_trace_impl(entry_point="validate", file_paths=[class_methods], max_depth=5)
    ...
    def test_generic_function_calls(self, fixtures_dir):
        ...
        response = get_call_trace_impl(
            entry_point="execute", file_paths=[class_methods], max_depth=5  # QueryBuilder.execute<T>()
        )
    ...
    def test_interface_method_calls(self, fixtures_dir):
        ...
        response = get_call_trace_impl(entry_point="initialize", file_paths=[async_patterns], max_depth=8)
    ...
    def test_call_graph_completeness(self, fixtures_dir):
        ...
        edge_coverage_ratio = response.call_graph_stats.total_edges / max(
            1, response.call_graph_stats.total_functions - 1
        )
    ...
    def test_entry_point_validation(self, fixtures_dir):
        ...
        response = get_call_trace_impl(entry_point="", file_paths=[simple_calls], max_depth=5)
        ...
        response = get_call_trace_impl(entry_point="nonexistentFunction", file_paths=[simple_calls], max_depth=5)
