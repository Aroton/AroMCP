...
class TestProgressiveTypeResolution:
    ...
    def test_progressive_resolution_performance_comparison(self, generic_functions_file):
        ...
        basic_result = get_function_details_impl(
            functions=functions_to_test, file_paths=generic_functions_file, include_types=True, resolution_depth="basic"
        )
    ...
    def test_resolution_depth_content_differences(self, generic_functions_file):
        ...
        basic_result = get_function_details_impl(
            functions=test_function, file_paths=generic_functions_file, include_types=True, resolution_depth="basic"
        )

        generic_result = get_function_details_impl(
            functions=test_function, file_paths=generic_functions_file, include_types=True, resolution_depth="generics"
        )
...
class TestTypeDefinitionExtraction:
    ...
    def test_interface_definition_extraction(self, temp_project):
        ...
        result = get_function_details_impl(
            functions="createUser", file_paths=str(test_file), include_types=True, resolution_depth="basic"
        )
    ...
    def test_type_alias_definition_extraction(self, temp_project):
        ...
        result = get_function_details_impl(
            functions="processStatus", file_paths=str(test_file), include_types=True, resolution_depth="generics"
        )
    ...
    def test_class_definition_extraction(self, temp_project):
        ...
        result = get_function_details_impl(
            functions="createUser", file_paths=str(test_file), include_types=True, resolution_depth="generics"
        )
    ...
    def test_enum_definition_extraction(self, temp_project):
        ...
        result = get_function_details_impl(
            functions="assignRole", file_paths=str(test_file), include_types=True, resolution_depth="basic"
        )
    ...
    def test_nested_type_resolution(self, temp_project):
        ...
        result = get_function_details_impl(
            functions="updateUserProfile", file_paths=str(test_file), include_types=True, resolution_depth="generics"
        )
