...
def shared_types_monorepo(tmp_path):
    ...
    (proj_a / "tsconfig.json").write_text(json.dumps({
        "compilerOptions": {
            "composite": True,
            "declaration": True
        },
...
""")
    ...
    (proj_b / "tsconfig.json").write_text(json.dumps({
        "compilerOptions": {
            "composite": True
        },
        "references": [
...
""")
    ...
    (proj_c / "tsconfig.json").write_text(json.dumps({
        "compilerOptions": {
            "composite": True
        },
        "references": [
    ...
    (proj_c / "package.json").write_text(json.dumps({
        "name": "@test/project-c",
        "version": "1.0.0",
        "dependencies": {
            "@test/project-a": "workspace:*"
