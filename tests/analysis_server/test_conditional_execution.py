...
class TestConditionalCallAnalysis:
    ...
    def test_if_else_branch_detection(self, conditional_calls_file):
        ...
        response = get_call_trace_impl(
            entry_point="processUser", file_paths=[conditional_calls_file], max_depth=10, analyze_conditions=True
        )
    ...
    def test_switch_statement_branches(self, conditional_calls_file):
        ...
        response = get_call_trace_impl(
            entry_point="processUser", file_paths=[conditional_calls_file], max_depth=8, analyze_conditions=True
        )
    ...
    def test_try_catch_error_paths(self, conditional_calls_file):
        ...
        response = get_call_trace_impl(
            entry_point="processUser", file_paths=[conditional_calls_file], max_depth=12, analyze_conditions=True
        )
    ...
    def test_nested_conditional_analysis(self, conditional_calls_file):
        ...
        response = get_call_trace_impl(
            entry_point="processUser", file_paths=[conditional_calls_file], max_depth=15, analyze_conditions=True
        )
    ...
    def test_early_return_handling(self, simple_calls_file):
        ...
        response = get_call_trace_impl(
            entry_point="login", file_paths=[simple_calls_file], max_depth=8, analyze_conditions=True
        )
...
class TestExecutionPathProbability:
    ...
    def test_execution_probability_calculation(self, fixtures_dir):
        ...
        response = get_call_trace_impl(
            entry_point="complexBusinessLogic", file_paths=[conditional_calls], max_depth=10, analyze_conditions=True
        )
    ...
    def test_high_probability_paths(self, fixtures_dir):
        ...
        response = get_call_trace_impl(
            entry_point="complexBusinessLogic", file_paths=[conditional_calls], max_depth=8, analyze_conditions=True
        )
    ...
    def test_conditional_probability_composition(self, fixtures_dir):
        ...
        response = get_call_trace_impl(
            entry_point="complexBusinessLogic", file_paths=[conditional_calls], max_depth=12, analyze_conditions=True
        )
...
class TestControlFlowPatterns:
    ...
    def test_async_conditional_flow(self, fixtures_dir):
        ...
        response = get_call_trace_impl(
            entry_point="asyncConditionalFlow", file_paths=[conditional_calls], max_depth=20, analyze_conditions=True
        )
    ...
    def test_error_handling_branches(self, fixtures_dir):
        ...
        response = get_call_trace_impl(
            entry_point="asyncConditionalFlow", file_paths=[conditional_calls], max_depth=18, analyze_conditions=True
        )

        # Should detect different error handling paths
        error_handling_calls = {"logTimeoutError", "logNetworkError", "logUnknownError"}
...
class TestBranchPrediction:
    ...
    def test_condition_analysis(self, fixtures_dir):
        ...
        response = get_call_trace_impl(
            entry_point="processUser", file_paths=[conditional_calls], max_depth=10, analyze_conditions=True
        )
    ...
    def test_business_logic_probability(self, fixtures_dir):
        ...
        probabilities = [
            p.execution_probability for p in response.execution_paths if p.execution_probability is not None
        ]
    ...
    def test_path_coverage_analysis(self, fixtures_dir):
        ...
        response = get_call_trace_impl(
            entry_point="processUser", file_paths=[conditional_calls], max_depth=15, analyze_conditions=True
        )
    ...
    def test_edge_case_conditions(self, fixtures_dir):
        ...
        response = get_call_trace_impl(
            entry_point="validateCredentials", file_paths=[simple_calls], max_depth=8, analyze_conditions=True
        )
