...
class TestDeepTracingPerformance:
    ...
    def test_multiple_entry_points_performance(self, complex_graph_file):
        ...
        entry_points = ["processUserRegistration", "processOrder", "generateUserAnalytics"]
        ...
        for entry_point in entry_points:
            ...
            response = get_call_trace_impl(
                entry_point=entry_point, file_paths=[complex_graph_file], max_depth=12, analyze_conditions=True
            )
    ...
    def test_performance_with_cycles(self, recursive_functions_file):
        ...
        response = get_call_trace_impl(
            entry_point="factorial", file_paths=[recursive_functions_file], max_depth=20, analyze_conditions=True
        )
...
class TestMemoryUsageRequirements:
    ...
    def test_memory_cleanup_after_analysis(self, fixtures_dir):
        ...
        for i in range(3):
            response = get_call_trace_impl(
                entry_point="processUserRegistration", file_paths=[complex_graph], max_depth=12, analyze_conditions=True
            )
    ...
    def test_concurrent_analysis_safety(self, fixtures_dir):
        ...
        def run_analysis(entry_point):
            ...
            return get_call_trace_impl(
                entry_point=entry_point, file_paths=[complex_graph], max_depth=10, analyze_conditions=True
            )
