...
class VersionManager:
    ...
    def check_compatibility(self, old_version: dict[str, Any], new_version: dict[str, Any]) -> bool:
        ...
        compatible_versions = {"v1": ["v1", "v2"], "v2": ["v2"]}
    ...
    def get_migration_plan(self, from_version: str, to_version: str) -> dict[str, Any] | None:
        """Get migration plan between versions."""
        migration_paths = {
            ("v1", "v2"): {
                "steps": ["Add validation field support", "Update step processors", "Migrate existing workflows"],
