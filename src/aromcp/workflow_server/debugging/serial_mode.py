...
class SerialDebugMode:
    ...
    def __init__(self):
        ...
        # Callbacks
        self._before_step_callback: Optional[Callable] = None
        self._after_step_callback: Optional[Callable] = None
    ...
    def get_next_step(self) -> Optional[SerialExecutionStep]:
    ...
    def complete_step(self, step: SerialExecutionStep, result: Any, error: Optional[Exception] = None):
...
class AsyncSerialDebugMode(SerialDebugMode):
    ...
    async def complete_step_async(self, step: SerialExecutionStep, result: Any, 
