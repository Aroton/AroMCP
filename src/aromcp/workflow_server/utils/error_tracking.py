...
def create_error_response(
    message: str, code: str = "OPERATION_FAILED", extra_data: dict[str, Any] = None
) -> dict[str, Any]:
    ...
    error_data = {
        "code": code,
        "message": message,
        "location": {"file": location["file"], "line": location["line"], "function": location["function"]},
    }
...
def create_workflow_error(
    message: str, workflow_id: str = None, step_id: str = None, code: str = "WORKFLOW_ERROR"
) -> dict[str, Any]:
