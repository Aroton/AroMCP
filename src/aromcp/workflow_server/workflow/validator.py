...
class WorkflowValidator:
    ...
    # Valid step types
    VALID_STEP_TYPES = {
        "state_update", "mcp_call", "user_message", "user_input",
        "shell_command", "conditional", "while_loop", "foreach",
        "parallel_foreach", "break", "continue", "batch_state_update",
        "agent_shell_command", "internal_mcp_call", "conditional_message"
    }
    ...
    def _validate_state(self, default_state: Optional[Dict[str, Any]], 
    ...
    def _validate_inputs(self, inputs: Optional[Dict[str, Any]]):
    ...
    def _validate_sub_agent_tasks(self, tasks: Optional[Dict[str, Any]]):
