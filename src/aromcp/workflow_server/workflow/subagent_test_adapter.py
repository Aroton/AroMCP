...
class SubAgentManager:
    ...
    def execute_parallel_tasks(
        ...
        with self._lock:
            ...
            for item in work_items:
                ...
                self._active_contexts[item_id] = {"status": "active", "start_time": time.time()}
            ...
            with concurrent.futures.ThreadPoolExecutor(max_workers=max_parallel) as executor:
                ...
                for item in work_items:
                    ...
                    future = executor.submit(
                        self._execute_with_timeout, item, task_def, timeout_seconds, error_isolation
                    )
    ...
    def _execute_with_timeout(
        self, item: dict[str, Any], task_def: dict[str, Any], timeout_seconds: float | None, error_isolation: bool
    ) -> dict[str, Any]:
        ...
        with self._lock:
            return {
                ...
                "cleanup_success_rate": (
                    self._monitoring_data["contexts_cleaned_up"] / self._monitoring_data["contexts_created"]
                    if self._monitoring_data["contexts_created"] > 0
                    else 0.0
                ),
            }
    ...
    def get_memory_statistics(self) -> dict[str, Any]:
        ...
        return {
            ...
            "contexts_created": self._monitoring_data["contexts_created"],
            "average_memory_per_context": (
                process.memory_info().rss / self._monitoring_data["contexts_created"]
                if self._monitoring_data["contexts_created"] > 0
                else 0
            ),
        }
